...
_TEXTOS = {
    ...
    "s2_lbl_select_transformations": {"en": "Select transformations:", "pt": "Selecione as transformações:"},
    "s2_chk_log10": {"en": "-Log10 (Only > 0 - pIC50|pMIC)", "pt": "-Log10 (Somente > 0 - pIC50|pMIC)"},
    "s2_chk_logn": {"en": "ln (Only > 0)", "pt": "ln (Somente > 0)"},
    "s2_chk_sqrt": {"en": "Square root (Only >= 0)", "pt": "Raiz quadrada (Somente >= 0)"},
    "s2_chk_cbrt": {"en": "Cubic root (All values)", "pt": "Raiz cúbica (Todos os valores)"},
    "s2_chk_boxcox": {"en": "Box-Cox (Only > 0)", "pt": "Box-Cox (Somente > 0)"},
    "s2_chk_yeojohnson": {"en": "Yeo-Johnson (All values)", "pt": "Yeo-Johnson (Todos os valores)"},
    ...
    "s3_btn_scatter_plot": {"en": "View \nScatter Plot", "pt": "Ver \nGráfico de Dispersão"},
    "s3_chk_moving_average": {"en": "Moving Average", "pt": "Média Móvel"},
    ...
    "s3_lbl_correlation_hint": {
        "en": "(Only for Variable 1 and Variable 2)",
        "pt": "(Somente para Variável 1 e Variável 2)",
    },
    ...
    "s4_lbl_select_structure_column": {"en": "Select Structure \nColumn:", "pt": "Selecione a Coluna \nde Estrutura:"},
    "s4_btn_select_structures_file": {"en": "Or Select \nStructures File", "pt": "Ou Selecione o \nArquivo de Estruturas"},
    "s4_lbl_select_bioactivity_column": {"en": "Select Bioactivity \nColumn:", "pt": "Selecione a Coluna \nde Bioatividade:"},
    "s4_lbl_select_name_column": {"en": "Select Name \nColumn:", "pt": "Selecione a Coluna \nde Nome:"},
    ...
    "s7_btn_hist_mahalanobis": {"en": "Hist Mahalanobis", "pt": "Histograma Mahalanobis"},
    "s7_btn_pca_scatter_ad": {"en": "PCA Scatter (AD)", "pt": "Dispersão PCA (DA)"},
    "s7_btn_similarity_dist": {"en": "Similarity Dist", "pt": "Distribuição de Similaridade"},
    ...
    "edit_btn_select_predictions_df": {"en": "Select Predictions\n Dataframe", "pt": "Selecionar Dataframe\n de Predições"},
    "edit_placeholder_select_predictions_df": {"en": "Select Predictions Dataframe", "pt": "Selecione o Dataframe de Predições"},
    "edit_lbl_select_id_column": {"en": "Select ID column:", "pt": "Selecione a coluna de ID:"},
    "edit_lbl_select_predictions_column": {"en": "Select predictions column:", "pt": "Selecione a coluna de predições:"},
    "edit_lbl_dataframe2": {"en": "Dataframe 2:", "pt": "Dataframe 2:"},
    "edit_btn_select_ad_df": {"en": "Select AD\n Dataframe", "pt": "Selecionar Dataframe\n de DA"},
    "edit_placeholder_select_ad_df": {"en": "Select AD Dataframe", "pt": "Selecione o Dataframe de DA"},
    "edit_lbl_select_value_column": {"en": "Select Value column:", "pt": "Selecione a coluna de Valor:"},
    ...
    "edit_lbl_select_column1": {"en": "Select Column: 1", "pt": "Selecione a Coluna: 1"},
    "edit_lbl_select_column2": {"en": "Select Column 2", "pt": "Selecione a Coluna 2"},
