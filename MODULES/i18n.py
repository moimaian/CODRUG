...
_TEXTOS = {
    ...
    "s7_lbl_ad_expl_compound": {"en": "Highlight compound:", "pt": "Destacar composto:"},
    "s7_chk_ad_expl_3d": {"en": "3D scatter", "pt": "Dispersão 3D"},
    "s7_chk_ad_expl_kde": {"en": "Train as KDE density", "pt": "Treino como densidade KDE"},
    "s7_chk_ad_expl_marginals": {"en": "Marginal histograms (2D)", "pt": "Histogramas marginais (2D)"},
